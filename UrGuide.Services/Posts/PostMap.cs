    ...
    class PostMap : Profile
    {
        public PostMap()
        {
            CreateMap<Post, PostModel>()
                ...
                .ForMember(x => x.ReservedSeats, x => x.MapFrom(f => f.Attributes.FirstOrDefault(a => a.Name == nameof(AttributeTypes.ReservedSeats))))
                .ForMember(x => x.EndDate, x => x.MapFrom(f => f.Attributes.FirstOrDefault(a => a.Name == nameof(AttributeTypes.DateEnd))))
                .ForMember(x => x.EndTime, x => x.MapFrom(f => f.Attributes.FirstOrDefault(a => a.Name == nameof(AttributeTypes.TimeEnd))))
