...
{
    public partial class Adding_Category_ToPostSearch_View : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql($@"ALTER VIEW {Constants.Schema}.Post_Search AS
                    SELECT P.PostId, P.Location, P.UserId, PA3.Value AS Rating, ISNULL(TRY_CONVERT(DATETIME, PA1.Value + ' ' + PA2.Value), GETUTCDATE()) AS EndDate, PA4.Value AS GeoLocation, PA5.Value AS Categories 
                    ...
                    JOIN {Constants.Schema}.Post_Attributes PA5 ON PA5.PostId = P.PostId AND PA5.Name LIKE '{nameof(AttributeTypes.Categories)}'
                    ");
        }
