...
const LeftBar = () => {
    ...
    const content = categories.slice(0, 4).map((category, i) =>
        ...
        <div key={i} className="col-lg-12 row w-auto p-2 ml-1 my-1 mb-4">
    ...
    return (
        <div className="col-lg-2 w-auto pl-2 m-0 leftbar">
            <div className={`col-lg-12 m-2 p-0 pl-3 my-3`} style={{ textTransform: 'uppercase', fontSize: '12px' }} ><b>Top categories</b></div>
